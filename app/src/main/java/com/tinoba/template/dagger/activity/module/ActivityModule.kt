...
import com.tinoba.template.ui.home.NewsListAdapter
...
class ActivityModule(private val daggerActivity: DaggerActivity) {
    ...
    @Provides
    @ActivityScope
    internal fun provideNewsListAdapter(layoutInflater: LayoutInflater, @ForActivity context: Context): NewsListAdapter {
        return NewsListAdapter(layoutInflater, context)
    }
